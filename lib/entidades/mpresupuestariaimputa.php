...
class EntidadMpresupuestariaimputa
{
	private $_id; 
	private $_monto;
	private $_tipoImpu;
   ...
   public function GetTipoImpu(){
	...
	public function __clone()
	{
		...
		$this->_anno = ($this->_anno !== null) ? clone $this->_anno : null;
		$this->_tipo = ($this->_tipo !== null) ? clone $this->_tipo : null;
	...
	public function UTF8Encode(){
		...
		$this->_anno = utf8_encode($this->_anno);
