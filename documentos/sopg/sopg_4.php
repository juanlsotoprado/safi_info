...
?>
	...
	<td colspan="4" class="normalNegroNegrita" align="center">REVISAR SOLICITUD DE PAGO</td>
			...
			<td  width="531" class="normalNegro" > <?php echo $codigo;?></td>
			</tr>
			<tr> 
		...
		<td class="normalNegro" ><?php echo $email;?></td>
			...
			<td class="normalNegro" ><?php echo $dependencia;?><input type="hidden" name="dependencia" value="<?=$dependencia;?>"></td>
			</tr>
			<tr> 
...
?>
	...
	<tr>
		<td colspan="4">
			...
			<td class="normalNegro" width="531"><?php echo $nombre_bene;?></td>
			</tr>
			<tr> 
		...
		?>
		   ...
		   <input name=<?php echo "centro_costo".$ii;?>  type="texto" class="normalNegro" id=<?php echo "centro_costo".$ii;?> size="15" maxlength="15"   valign="right"  align="right" value="<?php echo $centroc;?>" readonly="true"/>
                  ...
                  <td  class="peq" align="left" width="10%">
                    <div align="center">
                      <input name=<?php echo "txt_imputa_unidad".$ii;?>  type="texto" class="normalNegro" id=<?php echo "txt_imputa_unidad".$ii;?> size="10" maxlength="10"   valign="right"  align="right" value="<?php echo $matriz_uel[$ii];?>" readonly="true"/>
                    </div></td>
  ...
  ?>	
	<tr>
		<td class="normal" colspan="5" align="center" >
			...
			<td width="10%" class="normalNegroNegrita" align="center">
		...
		<?
		} //Del If si tiene datos de retenion y forma de pago
...
<tr>
		<td class="normal" colspan="5" align="center" ><BR>
			...
			<?}?>
			<tr>
			<td height="19" colspan="1" align="left" class="normalNegrita">TOTAL OTRAS RETENCIONES :		      </td>
...
<?}?>
	...
	<td height="21" colspan="4" valign="midden" align="left" class="normalNegrita">	En Bs.
	  <input type="text" name="txt_monto_neto" size="20" class="normalNegro" readonly="true" value="<?php echo(number_format($tt_neto,2,'.',',')); ?>">
	  <input type="hidden" name="monto_neto" value="<?php echo $tt_neto;?>"></input></td>
	</tr>
	<tr> 
