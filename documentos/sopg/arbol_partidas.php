...
<?php
//PARTIDAS PADRES
$sql="SELECT * FROM sai_consulta_partidas(".$an_o_presupuesto.",'4',1) as resultado(a varchar,b int4,c varchar,d bool)";
...
{   
	...
	if((v=='') && (c==''))
	{
	   alert('Seleccione una categor\u00EDa de imputaci\u00F3n')
...
{   
	if(tipo==0)
	{
	   if(document.form.txt_cod_pda.value=="")
	   {
		...
		var codigo_part=document.form.txt_cod_pda.value;
...
{   
	...
	for(i=0;i<partidas.length;i++)
	{
		...
		//	imp_4.className = "normalNegro";
			...
			//MONTO EXENTO
			//Se crea la quinta columna
			var td5 = window.opener.document.createElement("td");
			td5.setAttribute("align","Center");
			td5.className = 'normalNegro';
			name="txt_monto_exento"+j;
			if(pos_nave>0)
			{
			    var imp_5 = window.opener.document.createElement('<input type="text" name="'+name+'" onKeyUp="FormatCurrency(this)">');		
			}
			else
			   {
...
<form name="form" method="post" action="">
  <div align="center">
    <table width="480" border="0" class="tablaCentral" id="tbl_pda">
      ...
      <tr> 
        <td class="normal" valign="middle" > <input name="txt_cod_pda" type="text" disabled="true" class="normal" id="txt_cod_pda" size="16" maxlength="16"/></td>
        <td valign="middle" class="Normal"><div align="center"><input name="txt_des_pda" type="text" disabled="true" class="normal" id="txt_des_pda" size="50"/></div></td>
