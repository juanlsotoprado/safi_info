...
if ($valido)
{
	if ($esta_id==15) 
	{
		...
		if ($resultado_set_memo)
		{
			$row_memo = pg_fetch_array($resultado_set_memo ,0);
			$memo_id=$row_memo['cod_memo'];
...
?>
	<tr>
		<td colspan="4">
			<table width="100%">
			<tr class="td_gray"> 
	<td colspan="4" class="normalNegroNegrita" align="center">ANULACI&Oacute;N SOLICITUD DE PAGO</td>
  </tr>
			<tr  class="td_gray"> 
			...
			<td class="normalNegro" width="555"> <?php echo $codigo;?></div></td>
			</tr>
			<tr> 
	...
	<tr>
		<td height="176" colspan="4">
			...
			<td class="normalNegro" width="555"><?php echo $sopg_detalle;?></td>
			</tr>
			<tr> 
			<td height="21" colspan="2"><div  class="normalNegrita">Fecha de Solicitud:</div></td>
			<td class="normalNegro" width="555"><?php echo $sopg_fecha;?>			</td>
			</tr>
			<tr> 
	...
	<tr>
		...
		<table width="60%" border="0"  class="tablaalertas" align="center">
          ...
          <tr>
            <td  class="normal" align="center" colspan="3">
			    ...
			    ?>
                  ...
                  <td  class="peq" align="left" width="19%">
                    <div align="center">
                      ...
                      <input name=<?php echo "centroc".$ii;?>  type="text" class="normalNegro" id=<?php echo "centroc".$ii;?> size="15" maxlength="15"   valign="right"  align="right" value="<?php echo $centroc;?>" readonly="true"/>
	...
	<tr class="td_gray"> 
	<td height="21" colspan="4" valign="midden"><div align="left" class="normalNegrita"> 
	...
	En Letras:<textarea name="txt_monto_letras" id="txt_monto_letras" rows="2" cols="65" class="normalNegro" readonly></textarea></td>
		...
		<td class="normal" colspan="5" align="center" >
			...
			<td width="10%" class="normalNegrita" align="center">Tipo de Retencion</td>
		...
		?>
			...
			<td height="19" colspan="4" align="right" class="normalNegro"><input name="txt_monto_retenciones_tt" type="text" class="normalNegro" id="txt_monto_retenciones_tt" value="<?php echo(number_format($tt_retencion,2,'.',',')); ?>" size="25" maxlength="25" readonly="true" align="right"> </td>
			</tr>
			</table>		</td>
		</tr>
	...
	<textarea name="txt_motivo" rows="3" cols="75" class="normalNegro"></textarea>	</td>
	</tr>
	<tr>
      <td colspan="5">
	...
	?>
    <tr>
	  <td height="58" colspan="4" class="normal" align="center">
	   <br><div align="center">
