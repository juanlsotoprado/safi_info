...
<tr class="td_gray"> 
		<td colspan="2" class="normalNegroNegrita">TRANSFERENCIA NRO.: <a href="javascript:abrir_ventana('documentos/pgch/pgch_detalle.php?codigo=<?php echo trim($codigo);?>')"><?php echo $codigo;?></a></td>
	</tr>
	<tr> 
...
<?}?>
	<tr class="td_gray"> 
	<td colspan="2" class="normalNegroNegrita">ANULACI&Oacute;N DE LA TRANSFERENCIA</td>
	</tr>	
	<tr>
