...
<script><!--
	...
	function aprobar(){
		if(confirm(pACUTE+'Est'+aACUTE+' seguro que desea aprobar esta Orden de Compra y su An'+aACUTE+'lisis de Cotizaciones?.')){
			document.getElementById("accion").value = '<?= ACCION_APROBAR_REQUISICION?>';
			document.formularioOrdenDeCompra.submit();
		}
	}
	
	function devolver(){
		if(confirm(pACUTE+'Est'+aACUTE+' seguro que desea devolver esta Orden de Compra?.')){
...
?>
	...
	function generarOrdenDeCompraPdf2(){
		location.href = "ordenDeCompra_PDF.php?tipo=F&idOrdc=<?= $idOrdc?>";
	}

	function generarAnalisisDeCotizacinoPdf2(){
		location.href = "analisisDeCotizacion_PDF.php?tipo=F&idOrdc=<?= $idOrdc?>";
	}

	function generarMemoOrdenacionPagoPdf(){
		factura = "";
		//if (document.getElementById("factura").value=="") {
			//do {
				factura = prompt("Ingrese el n"+uACUTE+"mero de factura",document.getElementById("factura").value);
				if (factura=="") {
					alert("Debe indicar el n"+uACUTE+"mero de factura");
					return;
		...
		//if(document.getElementById("concepto").value=="") {
			//do {
				if (document.getElementById("concepto").value=="") {
					concepto = prompt("Ingrese el concepto",document.getElementById("justificacion").value);					
				}else{
					concepto = prompt("Ingrese el concepto",document.getElementById("concepto").value);
				}
		...
		if ( factura != null && concepto != null ) {
			document.getElementById("factura").value = factura;
			document.getElementById("concepto").value = concepto;
			document.getElementById("tdFactura").innerHTML = factura;
			document.getElementById("tdConcepto").innerHTML = concepto;
			location.href = "memoOrdenacionPago_PDF.php?idOrdc=<?= $idOrdc?>&factura="+factura+"&concepto="+concepto;
		}
	}
<?php
}
...
if($esta_id==7 || $esta_id==15){
	...
	if($memos>0){
		...
		$depeIdInstancia = $row["depe_cosige"];//Revisar Dependencia de Instancia que Devuelve
...
?>
<form name="formularioOrdenDeCompra" method="post" action="coordinadorOrdenDeCompraAccion.php" id="formularioOrdenDeCompra">
	<input type="hidden" id="codigo" name="codigo" value="<?= $codigo?>"/>
	<input type="hidden" id="codigoCR" name="codigoCR" value="<?= $codigoCR?>"/>
	<input type="hidden" id="idOrdc" name="idOrdc" value="<?= $idOrdc?>"/>
	...
	<table width="100%" align="center" background="../../imagenes/fondo_tabla.gif" class="tablaalertas">
		...
		<tr>
			<td align="left" height="24" width="200px;">
				N&deg; An&aacute;lisis de Cotizaci&oacute;n:
			</td>
			<td class="normalNegro"><?= $codigo_analisis_cotizacion?></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2">
				...
				<tbody id="cotizaciones">
					...
					?>
					<tr class="normalNegro" id="articulo<?= $row["id"]?>">
	...
	<tr>
		<td height="16" colspan="2">
			...
			<div align="center" class="normal" style="height: 50px;margin-top: 20px;">
				<div style="margin-top: 12px;float: left;text-align: right;width: 50%;">Para generar su <b>AN&Aacute;LISIS DE COTIZACIONES</b> en formato PDF haga clic</div>
				<div style="float: right;width: 50%;">
					<table align="left">
						<tr>
							<td align="center" width="150px">
								<a href="javascript: generarAnalisisDeCotizacinoPdf1();">aqu&iacute;</a>
								<a href="javascript: generarAnalisisDeCotizacinoPdf1();"><img src="../../imagenes/pdf_ico.jpg" border="0" align="center"/></a>
							</td>
							<td align="center" width="150px">
								<a href="javascript: generarAnalisisDeCotizacinoPdf2();">aqu&iacute;</a>
								<a href="javascript: generarAnalisisDeCotizacinoPdf2();"><img src="../../imagenes/pdf_ico.jpg" border="0" align="center"/></a>
							</td>
						</tr>
						<tr>
			...
			<br/>
			<div align="center" class="normal" style="height: 50px;margin-top: 20px;">
				<div style="margin-top: 12px;float: left;text-align: right;width: 50%;">Para generar su <b>ORDEN DE COMPRA</b> en formato PDF haga clic</div>
				<div style="float: right;width: 50%;">
					<table align="left">
						<tr>
							<td align="center" width="150px">
								<a href="javascript: generarOrdenDeCompraPdf1();">aqu&iacute;</a> 
							 	<a href="javascript: generarOrdenDeCompraPdf1();"><img src="../../imagenes/pdf_ico.jpg" border="0" align="center"/></a>
							</td>
							<!-- <td align="center" width="150px">
								<a href="javascript: generarOrdenDeCompraPdf2();">aqu&iacute;</a> 
								<a href="javascript: generarOrdenDeCompraPdf2();"><img src="../../imagenes/pdf_ico.jpg" border="0" align="center"/></a>
							</td> -->
						</tr>
						<tr>
							<td align="center"><b>Formato 1 (lineal)</b></td>
			...
			<br/>
			<div align="center" class="normal" style="height: 50px;margin-top: 20px;">
				<div style="margin-top: 12px;float: left;text-align: right;width: 50%;">Para generar su <b>MEMORANDO DE ORDENACI&Oacute;N DE PAGO</b> en formato PDF haga clic</div>
				<div style="float: right;width: 50%;">
					<table align="left">
						<tr>
							<td align="center" width="150px">
								<a href="javascript: generarMemoOrdenacionPagoPdf();">aqu&iacute;</a> 
							 	<a href="javascript: generarMemoOrdenacionPagoPdf();"><img src="../../imagenes/pdf_ico.jpg" border="0" align="center"/></a>
							</td>
						</tr>
						<tr>
							<td align="center"><b>Formato 1 (lineal)</b></td>
