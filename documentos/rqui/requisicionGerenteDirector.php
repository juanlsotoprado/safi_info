...
if($idRequ && $idRequ!=""){
	$query = 	"SELECT ".
				...
				"FROM sai_req_bi_ma_ser srbms, sai_estado se, sai_dependenci sda ".
				"WHERE ".
	...
	$gerencia_adscripcion = $row["depe_nombre"];
...
?>
<form action="requisicionGerenteDirectorAccion.php" method="post" id="formArticulosAccion" name="formArticulosAccion">
