<?php 
  ...
  $gerencia=$_SESSION['user_depe'];//$_REQUEST['gerencia'];
...
if(confirm('Desea agregar la partida: '+vector[1])){
    document.form1.txt_cod_pda.value=vector[0];
    document.form1.txt_des_pda.value=vector[1];  
    add_pda('tbl_pda','0');
  }
}
...
{   
	...
	if((v=='') && (c==''))
	{
	   alert('Seleccione una categoria de imputaci\u00F3n')
	   window.close()
	}
...
{   
	if(tipo==0)
	{
	   if(document.form1.txt_cod_pda.value=="")
	   {
		  alert("Debe seleccionar un c\u00F3digo de partida");
		  return;
	   }
		var codigo_part=document.form1.txt_cod_pda.value;
		//Verificamos si esta ya registrada
		for(i=tipo;i<partidas.length;i++)
		{
			if (partidas[i][0]==codigo_part)
			{
					alert("Partida ya seleccionada...");
					document.form1.txt_cod_pda.value='';
					document.form1.txt_des_pda.value='';
					return;
			}
		}

		//Verificaci�n despues de confirmada	
		var variable=document.form1.hid_arreglo.value;
	    arreglo = variable.split(",");
		var k;

		for(k=0; k<arreglo.length; k++)
		{
			if (arreglo[k]==codigo_part)
			{
					alert("Partida ya se encuentra confirmada...");
					document.form1.txt_cod_pda.value='';
					document.form1.txt_des_pda.value='';
					return;
			}
		...
		registro[0] = document.form1.txt_cod_pda.value;
		registro[1] = document.form1.txt_des_pda.value;
	...
	document.form1.txt_cod_pda.value = "";
	document.form1.txt_des_pda.value = "";
	document.form1.largo.value = partidas.length;
}
...
<body>
<?if ($gerencia==""){?>
<script> alert ('Debe especificar primero la Dependencia solicitante');</script>
<div align="center">
<a href="javascript:window.close()" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('cerrar','','../../imagenes/boton_cerrar_blk.gif',1)">
<img src="../../imagenes/boton_cerrar.gif" name="cerrar" width="90" height="31" border="0" id="cerrar" /></a>
</div>
 <?}else{?>
<div id="tunMe" >
</div> 
...
<form name="form1" method="post" action="">
  <div align="center">
    <table width="280" border="0" class="tablaCentral" id="tbl_pda">
      <tr> 
        ...
        <td  valign="middle"  bgcolor="#0099CC" class="normal">	    <div align="center"><span class="Estilo1"><strong> 
      ...
      <tr> 
        <td class="normal" valign="middle" > <input name="txt_cod_pda" type="text" disabled="disabled" class="normalNegro" id="txt_cod_pda" size="12" maxlength="15"/></td>
        <td valign="middle" class="Normal"><div align="center"><input name="txt_des_pda" type="text" class="normalNegro" id="txt_des_pda" size="30" disabled="disabled"/></div></td>
      ...
      <tr> 
		...
		<table width="60%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td> <div align="right">
            <input type="button" value="Confirmar" onclick="javascript:enviar()">
            </div></td>
