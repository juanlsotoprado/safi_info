...
<form action="" name="form" id="form" method="post" >
 <table width="700" align="center" background="imagenes/fondo_tabla.gif" class="tablaalertas" id="sol_via">
   <tr>
      <td height="15" colspan="2" valign="midden" class="td_gray"><span class="normalNegroNegrita"> Salida de activos y/o materiales</span> </td>
   </tr>
   	<tr>
   ...
   <tr>
	...
	<tr>
	  ...
	  <?php 
	   ...
	   <tr>
	    <td class="normal" hight="20"><div style="color:#FF0000;"><strong>Activos Asignados Previamente:</strong></div></td>
	   ...
	   <tr>
	    <td class="normal" hight="20"><div style="color:#FF0000;"><strong>Art&iacute;culos No generados o incompletos en el Acta:</strong></div></td>
	    <td class="normalNegro"><div style="color:#FF0000;"><strong>
  ...
  <br><br>
  <div align='center'><a target="_blank" class="normal" href="salida_activos_pdf.php?codigo=<?=$codigo;?>&tipo=s">Salida<img src="../../imagenes/pdf_ico.jpg" width="32" height="32" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target="_blank" class="normal" href="salida_activos_pdf.php?codigo=<?=$codigo;?>&tipo=a&solicitante=<?=$listado_depe;?>">Asignaci&oacute;n<img src="../../imagenes/pdf_ico.jpg" width="32" height="32" border="0"></a></div><br>
  	
</form>
<?php } else{?>
<br></br><div  style="color:#FF0000;" align="center"><b>No se puede emitir el Acta de Salida con la informaci&oacute;n suministrada,<br> Verifique el serial o <br>si ya fue previamente sacado del inventario el art&iacute;culo</b>
