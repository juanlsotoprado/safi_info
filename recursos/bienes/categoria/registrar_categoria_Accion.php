...
$sql = "select MAX(CAST(id as integer)) as codigo from bien_categoria";
...
<br />
<?
	$sql="INSERT INTO bien_categoria (id,nombre) VALUES ($codi_new, '".strtoupper($_POST['tipo'])."')";
   //echo($sql);
   $resultado=pg_exec($conexion,$sql);
   $sql="SELECT * FROM bien_categoria WHERE id='".$codi_new."'";
   $resultado=pg_exec($conexion,$sql);
	if ($row = pg_fetch_array($resultado))
	{
?>
<table width="466" align="center" background="../../../imagenes/fondo_tabla.gif" class="tablaalertas">
	<tr class="td_gray"> 
	<td height="15" colspan="2" align="midden"  class="normalNegroNegrita"><strong>Registro de categor&iacute;a de activos</strong></td>
    </tr>
<tr>
