...
FROM sai_bien_custodia t1,sai_empleado t2
...
$sql_custodia="SELECT cantidad,medida,nombre FROM sai_bien_item_custodia t1,sai_item t2 WHERE acta_id='".$codigo."' and t1.id=t2.id  ORDER BY t2.nombre";
