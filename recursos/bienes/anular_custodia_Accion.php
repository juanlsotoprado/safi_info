...
if ($memo_contenido==""){
  ...
  $sql  = "select * from sai_anular_custodia('".$_SESSION['login']."','".$acta."','".$memo_contenido."','".$_SESSION['user_depe_id']."') as memo_id";
...
<table width="300" align="center" background="imagenes/fondo_tabla.gif" class="tablaalertas" id="sol_via">
  <tr>
	<td height="15" colspan="2" valign="midden" class="td_gray"><span class="normalNegroNegrita">ANULACI&Oacute;N CUSTODIA DE ALMAC&Eacute;N   </span></td>
  </tr>
  <tr>
	<td class="normal"><strong>ACTA No: </strong><?php echo $acta;?></td>
  </tr>
  <tr>
	<td class="normalNegro">Fue retornada la custodia de esta acta al Galp&oacute;n</td>
