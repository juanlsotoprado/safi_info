...
<br />
<?
	$sql="UPDATE sai_arti_tipo SET tp_desc= '".$_POST['marc']."' WHERE tp_id='".$_POST['marc_cod']."'";
   //echo($sql);
   $resultado=pg_query($conexion,$sql);
   $sql="SELECT * FROM sai_arti_tipo WHERE tp_id='".$_POST['marc_cod']."'";
...
<table width="366" align="center" background="../../../imagenes/fondo_tabla.gif" class="tablaalertas">
	<tr class="td_gray"> 
	<td height="15" colspan="2" valign="midden" class="normalNegroNegrita"><strong>Modificar la categoria de activos</strong></td>
    </tr>
	<tr>
...
<br />
		...
		de la clasificacion de activos <br>
