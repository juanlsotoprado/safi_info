...
// Probar si esto se puede borrar
$anno_pres=2015;
$an_o_presupuesto=2015;

if (
	$campo_opcion=="codi" || strcmp($campo_opcion,"codi")==0
	|| $codigo_origen=="comp" || strcmp($codigo_origen,"comp")==0
	|| $campo_opcion=="sopg" || strcmp($campo_opcion,"sopg")==0		
...
function retorna(tex){
	...
	//if(confirm("Desea seleccionar  " + vector[0] + tipo +"?")){
		...
		if (window.opener.document.<?= $formulario?>.<?= $campo_cod_supe2?>)  
			window.opener.document.<?= $formulario?>.<?= $campo_cod_supe2?>.value=vector[5];
		if (window.opener.document.<?= $formulario?>.<?= $campo_cod_accion2?>)
                       ...
                       if($dependencia=='550'){
							...
							$sql_proyecto.= "AND 
									(
										...
										(sf1125.form_tipo = 1::BIT AND ((sf1125.form_id_p_ac = '111721' AND sf1125.form_id_aesp = '111721 E-1') OR (sf1125.form_id_p_ac = '114254' AND sf1125.form_id_aesp = '114254 E-2') OR (sf1125.form_id_p_ac = '2013-AC' AND sf1125.form_id_aesp = '2013-AC2') OR (sf1125.form_id_p_ac = '120670' AND sf1125.form_id_aesp = '120670 A-3-1') OR (sf1125.form_id_p_ac = '117659' AND sf1125.form_id_aesp = '117659 A-1')))
																			) ";
						...
						($dependencia !="150" && $dependencia!="350" && $dependencia!="400" && $dependencia!="450" && $dependencia!="200" && $dependencia!="500" && $dependencia!="050" && $dependencia!="452" && $dependencia!="550" && $dependencia!="600")? $sql_proyecto .= "AND sf1125.depe_cosige = '".$dependencia."'":"";
					...
					/*"position('".$dependencia."' in sf1125.depe_id)>0"*/
      				if($dependencia=='550'){
							...
							$sql_ace.= "AND 
									(
										(sf1125.depe_cosige = '".$dependencia."') OR 
										(sf1125.form_tipo = 1::BIT AND ((sf1125.form_id_p_ac = '111721' AND sf1125.form_id_aesp = '111721 E-1') OR (sf1125.form_id_p_ac = '114254' AND sf1125.form_id_aesp = '114254 E-2') OR (sf1125.form_id_p_ac = '120670' AND sf1125.form_id_aesp = '120670 A-3-1') OR  (sf1125.form_id_p_ac = '117659' AND sf1125.form_id_aesp = '117659 A-1')))
																			) ";
							...
							$sql_ace.= "AND 
									(
										(sf1125.depe_cosige = '".$dependencia."') OR 
										(sf1125.form_tipo = 1::BIT AND sf1125.form_id_p_ac = '117580' AND sf1125.form_id_aesp = '117580 B-3')
									) ";
						   ...
						   ($dependencia !="150" && $dependencia!="350" && $dependencia!="400" && $dependencia!="450" && $dependencia!="200" && $dependencia!="500" && $dependencia!="050" && $dependencia!="452" && $dependencia!="550" && $dependencia!="600")? $sql_ace .= "AND sf1125.depe_cosige = '".$dependencia."'":"";
