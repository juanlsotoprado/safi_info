			...
			$c=0;
				...
				while($row_sopor0=pg_fetch_array($resultado_sopor)) {
					...
					<tr>
						...
						?>
<?if ($carpeta!="memo"){?>
<a href="javascript:abrir_ventana('documentos/<?php echo $carpeta."/".$carpeta?>_detalle.php?codigo=<? echo $codigo_sopor;?>')" class="copyright"><?echo($soporte[$i][$j]);?></a>
<?}else{?>
  <a href="javascript:abrir_ventana('documentos/memo/memo_detalle.php?codigo=<? echo $codigo_sopor;?>')" class="copyright">	
