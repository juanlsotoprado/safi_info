...
if($codigo && $codigo!=""){
	...
	if($error == ""){
		...
		$sql="SELECT * FROM sai_modificar_asignacion_presupuestaria(".
																"'".$codigo."',".
																"".$tipoImputacion.",".
																"".$anioPresupuestario.",".
																"'".$proyAcc."',".
		...
		$codigo = $row[0];
		header("Location:detalle.php?codigo=".$codigo."&accion=modificar",false);
	}else{
		header("Location:modificar.php?codigo=".$codigo."&msg=".$error,false);
	}
}
ob_end_flush();
pg_close($conexion);
