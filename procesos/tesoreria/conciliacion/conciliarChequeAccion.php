		...
		if ($numero < 1) { // La operación no ha sido conciliada
			...
			$query = "SELECT pc.docg_id AS docg_id,
						...
						CASE WHEN (
							...
							ELSE 1
						END AS fecha_mayor,
						pc.nro_cuenta AS numero_cuenta
...
else echo "<div class='normalNegrita' align='center'>Error: Debe seleccionar al menos un cheque para conciliar";
?>
</div>
</body>
</html>
