...
elRTE.prototype.options   = {
	...
	pasteDenyAttr : ['id', 'name', 'language', 'onclick', 'ondblclick', 'onhover', 'onkeup', 'onkeydown', 'onkeypress'],
	/* If false - all text nodes will be wrapped by paragraph tag */
	allowTextNodes : true,
	/* allow browser specific styles like -moz|-webkit|-o */
	allowBrowsersSpecStyles : true,
	...
	panels      : {
		...
		elements   : ['horizontalrule', 'blockquote', 'div', 'stopfloat', 'pagebreak'],
		direction  : ['ltr', 'rtl'],
	...
	toolbars    : {
		...
		maxi     : [ 'copypaste', 'undoredo', 'elfinder', 'style', 'alignment', 'direction', 'colors', 'format', 'indent', 'lists','elements', 'tables', 'fullscreen'],
