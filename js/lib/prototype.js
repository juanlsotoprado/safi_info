...
Object.extend(String.prototype, (function() {
  ...
  function stripScripts() {
    return this.replace(new RegExp(Prototype.ScriptFragment, 'imagenes'), '');
  }

  function extractScripts() {
    var matchAll = new RegExp(Prototype.ScriptFragment, 'imagenes'),
...
if (Prototype.Browser.Opera) {
  ...
  Element.Methods.setOpacity = function(element, value) {
    ...
    if (value == 1)
      if (element.tagName.toUpperCase() == 'imagenes' && element.width) {
...
Element.addMethods = function(methods) {
  ...
  function findDOMClass(tagName) {
    ...
    var trans = {
      ...
      "INS": "Mod", "DEL": "Mod", "A": "Anchor", "imagenes": "Image", "CAPTION":
