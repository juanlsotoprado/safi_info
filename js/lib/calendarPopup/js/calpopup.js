...
function Calendar() {
	...
	this.daysOfWeek = "Dom Lun Mar Mie Jue Vie Sab".split(" ");
	this.months = "Enero Febrero Marzo Abril Mayo Junio Julio Agosto Septiembre Octubre Noviembre Diciembre".split(" ");
...
Calendar.prototype.buildString = function(){
	...
	tmpStr += '<thead><tr><td colspan="7"><ul>\n'+
			...
			'<ul id="cp_months"><li><a href="javascript:g_Calendar.clickMonth(0)">Enero</a></li><li><a href="javascript:g_Calendar.clickMonth(1)">Febrero</a></li><li><a href="javascript:g_Calendar.clickMonth(2)">Marzo</a></li><li><a href="javascript:g_Calendar.clickMonth(3)">Abril</a></li><li><a href="javascript:g_Calendar.clickMonth(4)">Mayo</a></li><li><a href="javascript:g_Calendar.clickMonth(5)">Junio</a></li><li><a href="javascript:g_Calendar.clickMonth(6)">Julio</a></li><li><a href="javascript:g_Calendar.clickMonth(7)">Agosto</a></li><li><a href="javascript:g_Calendar.clickMonth(8)">Septiembre</a></li><li><a href="javascript:g_Calendar.clickMonth(9)">Octubre</a></li><li><a href="javascript:g_Calendar.clickMonth(10)">Noviembre</a></li><li><a href="javascript:g_Calendar.clickMonth(11)">Diciembre</a></li></ul></li>\n' +
	...
	tmpStr += '</tr></thead><tfoot><tr><td colspan="7">Hoy es: <a href="javascript:g_Calendar.clickToday()" title="Go to current month">' + (/^d/.test(this.dateFormat)?dtToday.getDate() + ' ' + this.months[dtToday.getMonth()] + ' ':this.months[dtToday.getMonth()] + ' ' + dtToday.getDate() + ', ') + dtToday.getFullYear()+'</a></td></tr></tfoot><tbody>';
